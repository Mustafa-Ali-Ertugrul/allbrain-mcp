...
from allbrain.domains.learning.learning_safety.model import MAX_SIMULATION_WEIGHT
from allbrain.domains.learning.learning_safety.outcome_validator import OutcomeValidator
...
class TestOutcomeValidator:
    def test_no_real_provider_returns_sim_capped(self):
        ...
        combined, capped = v.compute_combined_effectiveness(
            sim_effectiveness=0.5,
            real_effectiveness=None,
        )
