...
class TestExplainability:
    def test_minimal_trace(self):
        ctx = DecisionContext(
            agent_id="a", task_type="t", contract=make_contract(), telemetry={"reputation": 0.5}, learning={}
        )
    ...
    def test_debug_trace(self):
        ctx = DecisionContext(
            agent_id="a",
            task_type="t",
            contract=make_contract(debug=True, fusion=True),
            telemetry={"reputation": 0.8},
            learning={"calibrated_trust": 0.5},
