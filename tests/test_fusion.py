...
class TestUnifiedScore:
    ...
    def test_custom_weights(self):
        s = unified_decision_score(
            capability=1.0, learning=0.0, dynamics=0.0, causal=0.0,
            capability_weight=0.5, learning_weight=0.2, dynamics_weight=0.2, causal_weight=0.1,
        )
    ...
    def test_weight_rebalance_fallsback(self):
        s1 = unified_decision_score(capability=0.8, learning=0.4, dynamics=0.4, causal=0.4, capability_weight=0.8, learning_weight=0.1, dynamics_weight=0.05, causal_weight=0.05)
        s2 = unified_decision_score(capability=0.8, learning=0.4, dynamics=0.4, causal=0.4)
        assert s1 != s2

    def test_determinism(self):
        s1 = unified_decision_score(capability=0.4, learning=0.6, dynamics=0.3, causal=0.7, capability_weight=0.3, learning_weight=0.3, dynamics_weight=0.2, causal_weight=0.2)
        s2 = unified_decision_score(capability=0.4, learning=0.6, dynamics=0.3, causal=0.7, capability_weight=0.3, learning_weight=0.3, dynamics_weight=0.2, causal_weight=0.2)
        assert s1 == s2

    def test_pure_deterministic(self):
        import hashlib
        s1 = unified_decision_score(capability=0.42, learning=0.37, dynamics=0.91, causal=0.15, capability_weight=0.25, learning_weight=0.25, dynamics_weight=0.25, causal_weight=0.25)
        s2 = unified_decision_score(capability=0.42, learning=0.37, dynamics=0.91, causal=0.15, capability_weight=0.25, learning_weight=0.25, dynamics_weight=0.25, causal_weight=0.25)
        assert s1 == s2