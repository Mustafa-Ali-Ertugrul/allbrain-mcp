SNAPSHOT_SCHEMA_VERSION = "7.0"
REDUCER_VERSION = "7.0"
COMPRESSION_VERSION = "1.1"

COMPATIBLE_SNAPSHOT_SCHEMA_VERSIONS = {"3.1", "4.0", "5.0", "6.0", SNAPSHOT_SCHEMA_VERSION}
...
def is_compatible(metadata: dict) -> bool:
    return (
        ...
        and metadata.get("reducer_version") in {"3.1", "4.0", "5.0", "6.0", REDUCER_VERSION}
