...
from allbrain.domains.collaboration.workspace.model import WORKSPACE_TEMPLATE_VERSION
...
def make_ws_added_payload(
    *, item_id: str, activation: float, source: str, tv: int = WORKSPACE_TEMPLATE_VERSION
) -> dict:
