...
from allbrain.domains.collaboration.agents.adapter import AgentAdapter
...
def _claude_default() -> AgentDefinition:
    return AgentDefinition(
        ...
        adapter_class_name="allbrain.domains.collaboration.agents.adapters.claude.ClaudeAdapter",
...
def _openai_default() -> AgentDefinition:
    return AgentDefinition(
        ...
        adapter_class_name="allbrain.domains.collaboration.agents.adapters.openai.OpenAIAdapter",
    )
...
def _gemini_default() -> AgentDefinition:
    return AgentDefinition(
        ...
        adapter_class_name="allbrain.domains.collaboration.agents.adapters.gemini.GeminiAdapter",
    )
...
def _qwen_default() -> AgentDefinition:
    return AgentDefinition(
        ...
        adapter_class_name="allbrain.domains.collaboration.agents.adapters.qwen.QwenAdapter",
    )
...
def _opencode_default() -> AgentDefinition:
    return AgentDefinition(
        ...
        max_context_tokens=64_000,
        adapter_class_name="allbrain.domains.collaboration.agents.adapters.opencode.OpenCodeAdapter",
    )
...
def _codex_default() -> AgentDefinition:
    return AgentDefinition(
        ...
        adapter_class_name="allbrain.domains.collaboration.agents.adapters.codex.CodexAdapter",
    )
...
def _mock_default() -> AgentDefinition:
    return AgentDefinition(
        ...
        adapter_class_name="allbrain.domains.collaboration.agents.adapters.mock.MockAdapter",
    )
