...
from allbrain.domains.analysis.world.models import SimulationResult, WorldState
...
class WorldHistory:
    ...
    def latest_state(self, project_path: str | None = None, limit: int = 5000) -> WorldState | None:
    ...
    def latest_simulation(self, project_path: str | None = None, limit: int = 5000) -> SimulationResult | None:
        state = WorldStateBuilder().build(self.events(project_path=project_path, limit=limit))
    ...
    def state_dict(self, project_path: str | None = None, limit: int = 5000) -> dict[str, Any]:
