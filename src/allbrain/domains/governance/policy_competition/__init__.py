from allbrain.domains.governance.policy_competition.competition_engine import CompetitionEngine
...
from allbrain.domains.governance.policy_competition.scorer import PolicyScorer
