...
from allbrain.domains.reasoning.tradeoff_engine.model import ParetoFrontier, TradeoffResult, UtilityResult
...
class Selector:
    ...
    Decision algorithm:
    1. CRITICAL objective'ler saÄŸlanmazsa aday elenir.
