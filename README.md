...
- 2460 tests collected; (pass rate varies by environment) in the latest successful CI run
...
- Python 3.13 coverage CI; measured coverage 79.66% in the latest successful run (enforced threshold: 80%)
