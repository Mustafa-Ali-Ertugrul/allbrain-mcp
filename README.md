...
- 2244 tests collected; (pass rate varies by environment) in the latest successful CI run
...
- Python 3.13 coverage CI; measured coverage 73.43% in the latest successful run (enforced threshold: 73%)
